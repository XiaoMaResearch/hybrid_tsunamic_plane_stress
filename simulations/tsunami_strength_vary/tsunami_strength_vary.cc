...
int main() {
  ...
  // numt = 2;
    ...
    double tau_d_const =0.3*50e6;
    double tau_s_const = 0.6*50e6;

    
    double S_low = (tau_s_const - 0.625*tau_0)/(0.625*tau_0 - tau_d_const);
    double S_high = (tau_s_const - 0.725*tau_0)/(0.725*tau_0 - tau_d_const);
    ...
    double mu_s_low = ((tau_0 + S_low*(tau_0 - tau_d_const)))/50e6;
    double mu_s_high =((tau_0 + S_high*(tau_0 - tau_d_const)))/50e6;
    
    
    std::cout<<"mu_s_low="<<mu_s_low<<std::endl;
    std::cout<<"mu_s_high="<<mu_s_high<<std::endl;
...
//        if ((x_main(k)>=-100.0e3)&&(x_main(k)<=50.0e3))
//        {
//            mu_s[0](k)= 0.6;
//        }
//        else
